...
const GameChannelCardSkeleton: React.FC<GameContentsProps> = ({ image, imageHeight }) => {
  return (
    <GameChannelCardContainer imageHeight={imageHeight}>
      <div className="game-channel-card-img-wrapper"></div>
...
export default GameChannelCardSkeleton;
